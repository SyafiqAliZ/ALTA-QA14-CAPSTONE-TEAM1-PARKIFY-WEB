...
public class AddParkingLocationPage {
    ...
    public void uploadImageValid(){
        File uploadFile = new File("src/main/java/org/example/resources/images/basura.jpg");

        WebElement fileInput = webDriver.findElement(By.id(":r4:-form-item"));
        fileInput.sendKeys(uploadFile.getAbsolutePath());
    }
    public void uploadImageInvalid(){
        File uploadFile = new File("src/main/java/org/example/resources/images/azkaban.jpg");
